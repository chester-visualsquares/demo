...
class Command(LabelCommand):
    ...
    def send_reminder(self, contact):
        ...
        html_template = ('signup_mobile_tdc_hkjf17/reminder_email_jfs_2.html')
        ...
        query_string_goal = urllib.urlencode({
            ...
            'laid': settings.SNM_TDC_HKJF17_FBCSID_PREFIX + '9804',
            'idgoal': 'G-RMD-EMAIL',
            'rec': 1,
