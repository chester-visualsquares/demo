...
class Command(LabelCommand):
    ...
    def send_reminder(self, contact):
        ...
        html_template = ('signup_mobile_tdc_hkelfae17/reminder_email_light_2.html')
        ...
        query_string_goal = urllib.urlencode({
            ...
            'laid': settings.SNM_TDC_HKELFAE17_FBCSID_PREFIX + '9801',
            'idgoal': 'G-RMD-EMAIL',
            'rec': 1,
